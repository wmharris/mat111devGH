...
## Another Example:  CPS85

Research Question:

>*Among non-white workers in 1985, who was earning higher wages, on average:  males or females?*

Define:

* $\mu_1 =$ mean wage for all non-white males in 1985
* $\mu_2 =$ mean wage for all non-white females in 1985

## Code

```{r eval = FALSE}
cnw <- subset(CPS85, race == "NW")
ttestGC(wage ~ sex, data = cnw,
        mu = 0, first = "M")
```
...
Better look at the samples:

```{r eval = FALSE}
bwplot(wage ~ sex, data = cnw)
```
...
Test of Significance:
	...
	Test Statistic:		t = 0.9364 
	Degrees of Freedom:	  53.06 
	P-value:		P = 0.3533
```
